...
start with make a node 

problem the node is not made 

so first pass we make the list and not assign the radndom node 

how to do the next pass to assign the node ? 

two loop and one work inside the other

start the loop again and reset the index
