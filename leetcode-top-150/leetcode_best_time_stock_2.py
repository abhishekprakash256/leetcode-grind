...
class Solution:
    def maxProfit(self, prices) -> int:
        ...
        and selling stock on multiple days, as long as there's a positive difference
        between the selling price and the buying price.
        passese the leetcode
        """
        # Base case: If there is only one price, no profit can be made.
        if len(prices) == 1:
            return 0
