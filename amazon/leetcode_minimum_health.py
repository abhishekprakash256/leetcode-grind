...
0-indexed integer array damage where damage[i] is the amount of health you 
will lose to complete the ith level.
...
class Solution():
	...
	def minimumHealth(self,damage, armour):
		"""
		The function to find the minimum armour needed
		"""
		...
		return total_damage - min(max_damage , armour) + 1 
